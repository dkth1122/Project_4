...
<div id="app">
	...
	<div><input placeholder="제목" v-model="aTitle"></div>
	<div><input placeholder="내용" v-model="aContent"></div>
	<div> 종류 : <select v-model="aKind">
		<option value="공지">공지</option>
		<option value="이벤트">이벤트</option>
	</select></div>
	<div> 아티스트 : <select v-model="artist">
...
var app = new Vue({
	...
	methods : {
        fnABoardAdd : function(){
        	 var self = this;
             var nparmap = {aTitle : self.aTitle, aContent : self.aContent, aKind : self.aKind, artist : self.artist};
             $.ajax({
                 url : "/aboard/add.dox",
                 dataType:"json",	
                 type : "POST", 
